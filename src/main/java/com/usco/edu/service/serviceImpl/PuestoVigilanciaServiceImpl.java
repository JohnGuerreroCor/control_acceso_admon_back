...
public class PuestoVigilanciaServiceImpl implements IPuestoVigilanciaService {
	...
	public List<PuestoVigilancia> obtenerPuestoVigilanciaPorBloqueTipoSinHorarioCompleto(int subsede, int tipo, String userdb) {
		...
		return puestoDao.obtenerPuestoVigilanciaPorBloqueTipoSinHorarioCompleto(subsede, tipo, userdb);
	...
	public List<PuestoVigilancia> obtenerPuestoVigilanciaPorBloqueTipoHorario(int subsede, int tipo, String userdb) {
		...
		return puestoDao.obtenerPuestoVigilanciaPorBloqueTipoHorario(subsede, tipo, userdb);

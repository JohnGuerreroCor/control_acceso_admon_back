...
public class PuestoVigilanciaRestController {
	...
	@GetMapping(path = "obtener-puesto-vigilancia-bloque-tipo-horario-completo/{subsede}/{tipo}/{username}")
	public List<PuestoVigilancia> obtenerPuestoVigilanciaPorBloqueTipoSinHorarioCompleto(@PathVariable int subsede, @PathVariable int tipo, @PathVariable String username) {
		
		return puestoVigilanciaServie.obtenerPuestoVigilanciaPorBloqueTipoSinHorarioCompleto(subsede, tipo, username);
		
	}
	
	@GetMapping(path = "obtener-puesto-vigilancia-bloque-tipo-horario/{subsede}/{tipo}/{username}")
	public List<PuestoVigilancia> obtenerPuestoVigilanciaPorBloqueTipoHorario(@PathVariable int subsede, @PathVariable int tipo, @PathVariable String username) {
		
		return puestoVigilanciaServie.obtenerPuestoVigilanciaPorBloqueTipoHorario(subsede, tipo, username);
